...
getCurrentUser = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ message: "Ocorreu um erro ao obter informações do usuário" });
  }
};
...
editUserInfo = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Ocorreu um erro ao editar as informações do usuário" });
  }
};
...
usersList = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Ocorreu um erro ao obter a lista de usuários" });
  }
};
